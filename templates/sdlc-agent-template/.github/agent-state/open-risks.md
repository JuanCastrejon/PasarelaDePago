...
- severidad: media
- area: bootstrap
- descripcion: intentar instalar la plantilla reusable mientras se reorganiza el corpus documental existente puede mezclar dos iniciativas y frenar el avance
- mitigacion: mantener el enfoque aditivo durante el piloto y posponer cualquier reorganizacion fuerte hasta validar el nuevo flujo
