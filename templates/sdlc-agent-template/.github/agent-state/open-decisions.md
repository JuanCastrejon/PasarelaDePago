...
- tema: secuencia de extraccion del template reusable
- estado: abierta
- owner sugerido: `Lead`
- contexto: se decidio arrancar el bootstrap en `PasarelaDePago` como piloto controlado antes de publicar un repositorio-template separado
- siguiente paso: validar `OpenSpec`, skills de analisis y matriz de tools externas dentro del repo y luego decidir el momento correcto de extraccion
